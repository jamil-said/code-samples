...
<div style="display: none;"><div class="checkbox">
...
<div class="checkbox">
  <label>
    ...
    <?php echo $entry_shipping; ?></label> <br /> <span style="color:red;">Note: for credit/debit card orders, the delivery and billing addresses must match (otherwise the transaction will fail). <a href="https://www.adoradeal.com/pay-delivery-tax" target="_blank" style="color:red;">More Info >></a> </span>
</div>
<?php } ?>
<?php if ($text_agree) { ?>

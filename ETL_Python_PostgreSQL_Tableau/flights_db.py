...
def uploadDB(fliLst, colLst, startTime):
    ...
    def connectDB():
        ...
        dbN, userN, hostN, portN = credL[0], credL[1], credL[3], credL[4]
        pswd = base64.b64decode(credL[2]).decode('utf-8')
        return psycopg2.connect(database=dbN, user=userN, password=pswd, \
    ...
    try:
        ...
        cur.execute("""CREATE TABLE  dim_origin (
            ...
            originairportcode VARCHAR NOT NULL,
        ...
        cur.execute("""CREATE TABLE  dim_destination (
            ...
            destairportcode VARCHAR NOT NULL,
    ...
    try:
        ...
        cur.execute("""CREATE TABLE fact_flights (
            ...
            origin_id INTEGER REFERENCES dim_origin (origin_id),
            dest_id INTEGER REFERENCES dim_destination (dest_id),
            flightnum INTEGER,
            tailnum VARCHAR,
            cancelled BOOLEAN,
            diverted BOOLEAN,
    ...
    try:
        ...
        BOOLEAN, ADD COLUMN distance_group VARCHAR;""")

...
data from a txt file of domestic US flights into a MySQL database. 
...
def processFile(f):
    ...
    # MySQL prevailing convention for identifiers is lower case, thus 
    ...
    # Connect and upload all data to MySQL database (handled by module 
    # flights_db)
